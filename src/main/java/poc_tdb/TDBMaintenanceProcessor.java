...
public class TDBMaintenanceProcessor {
	...
	public TDB_Maintenance createTDBMaintenance(String run_id, String baseFilename, 
	        String doneFileEntryValue, Timestamp currentIterationStartTime,
	        Integer numRecords, boolean isExceptionThrown) {
