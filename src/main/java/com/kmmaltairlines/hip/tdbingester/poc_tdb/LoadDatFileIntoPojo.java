...
public class LoadDatFileIntoPojo {
    ...
    public Boolean loadDatFile(String baseFilename, String doneFileEntryValue, ArrayList<DoneFileEntry> dotFiles, 
        ...
        // Construct the filename for the transformation script based on the base filename
        ...
        if (!Files.exists(filePath)) {
            ...
            try {
                // Load the .dat file into POJOs (Plain Old Java Objects) via the transformation service
                ...
                // If an exception occurs during the processing, prepare the variables for the error email
