...
/**
 * This exception is thrown when attempting to read a .enc file which does not
 * exist after having read a .done file. It is always assumed that a .done file
 * will be written after the .enc file has been fully uploaded to the SFTP
 * server.
 * 
